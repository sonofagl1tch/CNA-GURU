...
class CodeStack(Stack):
    ...
    def create_data_source_bucket(self, kms_key):
        ...
        agent_assets_bucket = s3.Bucket(
            ...
            bucket_name=f"{Aws.STACK_NAME}-agent-assets-{self.timestamp}",
            versioned=True,
        ...
        athena_bucket = s3.Bucket(
            self,
            "AthenaSourceBucket",
            bucket_name=f"{Aws.STACK_NAME}-athena-{self.timestamp}",
            versioned=True,
            removal_policy=RemovalPolicy.DESTROY,
            auto_delete_objects=True,
            encryption=s3.BucketEncryption.KMS,
        ...
        policy_statements = [
            iam.PolicyStatement(
                ...
                resources=[
                    ...
                    f"arn:aws:bedrock:{Aws.REGION}::foundation-model/anthropic.claude-3-sonnet-20240229-v1:0",
    ...
    def create_bedrock_agent(
        ...
        knowledge_base = BedrockKnowledgeBase(
            ...
            name=kb_name,
            description="Use this for returning descriptive answers and instructions directly from FIRST documentation. Use to answer qualitative/guidance questions such as 'how do I',  general instructions and guidelines.",
